...
boundaries <- boxplot((Memory~Type+Webapp),
                      ...
                      #notch=TRUE,
                      #las=2,
                      xlab="Memory usage by each web app due to ads and analytics",
                      ylab="Memory usage (Kbs)",
...
legend("topleft", legend = c("With","Without") , 
       col = c("tan1" , "slategray1") , bty = "n", pch=20 , pt.cex = 3, cex = 1, horiz = FALSE, inset = c(0, 0.1))

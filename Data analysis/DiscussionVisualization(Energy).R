...
both_ads_analytics_data <- read.csv("/Volumes/D/SE4GD/Third Semester/Green Lab/GreenLabProject/both_data_ads_analytics.csv")
...
mtext("Impact of ads and analytics for each web app", side=3, line=0.5)
mtext("Energy consumption (J)", side=4, line=0.5)
...
legend("topleft", legend = c("With","Without") , 
       col = c("mediumpurple1" , "olivedrab1") , bty = "n", pch=20 , pt.cex = 2, cex = 0.6, horiz = FALSE, inset = c(0.01, 0.1))
